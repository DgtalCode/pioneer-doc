...
.. sidebar:: **Геоскан "Пионер Мини"**

	Образовательный квадрокоптер с функциями доверенной среды для первого знакомства с автономными летательными аппаратами.

	**Pioneer Mini** - предназначен для комплексного обучения в рамках проведения уроков технологий или занятий по робототехнике в помещениях (Школах, ЦМИТов, Фаблабов, кружков, секций). 
