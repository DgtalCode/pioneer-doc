...
4. В открывшемся окне нажмите **"Далее"**. Коптер перейдёт в в режим загрузчика. (`Более подробно про режим загрузчика`_).
...
.. note:: При необходимости обновите версию приложения Geoscan Jump в разделе :doc:`../flight/geoscan_jump`
