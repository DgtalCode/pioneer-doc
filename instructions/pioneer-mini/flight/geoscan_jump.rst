...
В ручном режиме, управление квадрокоптером осуществляется с помощью мобильного приложения для смартфонов "Geoscan Jump". Перед началом работы загрузите актуальную версию с `официального сайта`_ или из `Google Play`_.
...
.. important:: Обратите внимание, что мобильное приложение поддерживается на устройствах с операционными системами Android 6.0+ и iOS 12.1+
...
.. important:: Ознакомьтесь с остальной частью инструкции, прежде чем начинать полет. Не забывайте, что квадрокоптер предназначен для полёта в помещениях.


.. _официального сайта: https://www.geoscan.aero/ru/products/pioneer/mini#pills-download
