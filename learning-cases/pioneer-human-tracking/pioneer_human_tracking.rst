...
.. important::
    Внимание! В данном проекте используется старая версия библиотеки Pioneer_SDK. Код нуждается в небольших корректировках!
    См. описание методов Pioneer_SDK в разделе Программирование.
