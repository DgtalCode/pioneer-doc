...
.. _Пионер Базовый: instructions/pioneer-standart/main-standart.html
...
.. raw:: html
    ...
    <div class="flex-content-wrapper">
        <div class="flex-content div-p1"> <p><b>«Геоскан Пионер»</b> — это линейка многофункциональных образовательных квадрокоптеров.</p> <p>Их можно использовать как учебную платформу в школе, авиамодельной секции, кружке робототехники или дома. </p> </div>

        <div class="flex-content div-p2">
            <p> С Пионерами вы сможете: </p>
            <ul>
...
.. tile::
    ...
    Кроме полета на дистанционном управлении, квадрокоптер «Пионер» может следовать заложенной перед взлетом программе и автономно выполнять прописанные задачи.
...
.. tile::
    ...
    В данном разделе документации вы найдете различные примеры проектов, созданных на базе квадрокоптеров серии «Пионер». А также методические указания для организации учебного процесса.
