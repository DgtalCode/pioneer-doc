...
.. tile::
    ...
    В данном разделе документации вы найдете различные примеры проектов, созданных на базе квадрокоптеров серии «Пионер», и методические указания для организации учебного процесса.
